...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'NA YANG', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '那洋的小世界🫠', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, NA YANG', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    process.env.NEXT_PUBLIC_GREETING_WORDS || '欢迎来到那洋的小世界🎉',
